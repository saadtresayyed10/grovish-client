...
const Footer = () => {
  return (
    <div className="flex justify-center items-center flex-col w-full">
      <div className="flex lg:justify-between lg:items-center flex-col lg:flex-row bg-gradient-to-tr from-violet-300 to-white text-black font-roobert w-full py-16 px-6">
        <div className="flex justify-start items-start flex-col lg:gap-y-4 gap-y-2">
          <h1 className="text-6xl font-bold capitalize">Grovish</h1>
          <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 lg:ml-10 ml-6">
        ...
        <div className="flex justify-start items-start lg:gap-x-28 gap-y-10 lg:mr-52 lg:ml-0 ml-8 lg:mt-0 mt-10 flex-col lg:flex-row">
          <AboutFooter />
          <Legal />
          <Social />
        </div>
